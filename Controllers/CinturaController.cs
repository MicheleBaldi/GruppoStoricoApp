...
namespace GruppoStoricoApp.Controllers
{
    ...
    public class CinturaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Numero,Taglia,Note,RuoloID")] Cintura cintura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Numero,Taglia,Note,RuoloID")] Cintura cintura)
        {
            if (id != cintura.ID)
            {
                return NotFound();
