...
namespace GruppoStoricoApp.Controllers
{
    ...
    public class VestitoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Numero,Taglia,RuoloID")] Vestito vestito)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Numero,Taglia,RuoloID")] Vestito vestito)
        {
            if (id != vestito.ID)
            {
                return NotFound();
