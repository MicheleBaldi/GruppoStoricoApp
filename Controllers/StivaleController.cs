...
namespace GruppoStoricoApp.Controllers
{
    ...
    public class StivaleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Numero,Taglia,Note,RuoloID")] Stivale stivale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Numero,Taglia,Note,RuoloID")] Stivale stivale)
        {
            if (id != stivale.ID)
            {
                return NotFound();
